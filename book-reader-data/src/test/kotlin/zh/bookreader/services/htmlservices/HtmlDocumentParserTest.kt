...
internal class HtmlDocumentParserTest {
    ...
    @CsvSource(
            ...
            "<div class=\"preface\">mock text</div>,     ->   , SECTION,   mock text, _",
            "<div class=\"colophon\">mock text</div>,    ->   , SECTION,   mock text, _",
            "<div class=\"chapter\">mock text</div>,     ->   , SECTION,   mock text, _",
            "<div class=\"index\">mock text</div>,       ->   , SECTION,   mock text, _",
            "<div class=\"sect1\">mock text</div>,       ->   , SECTION,   mock text, _",
            "<div class=\"sect2\">mock text</div>,       ->   , SECTION,   mock text, _",
            "<div class=\"sect3\">mock text</div>,       ->   , SECTION,   mock text, _",
            "<div class=\"sect4\">mock text</div>,       ->   , SECTION,   mock text, _",
            ...
            "<div class=\"chapter\">mock text</div>,     ->   , SECTION,   mock text, _",
            "<section data-type=\"appendix\">mock text</section>,   ->   , SECTION, mock text, _",
            "<section data-type=\"sect1\">mock text</section>,      ->   , SECTION, mock text, _",
            "<section data-type=\"sect2\">mock text</section>,      ->   , SECTION, mock text, _",
            "<section data-type=\"colophon\">mock text</section>,   ->   , SECTION, mock text, _",
            "<section data-type=\"chapter\">mock text</section>,    ->   , SECTION, mock text, _",
